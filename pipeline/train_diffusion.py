...
def build_model(device, cond_class):
    net = VPPrecond(
        img_resolution=32,
        img_channels=3,        # CIFAR10
...
def main():
    ...
    model = build_model(args.device, args.cond_class)
    ...
    for epoch in range(args.epochs):
        ...
        # for imgs, class_label in train_loader:
            ...
            if args.cond_class > 0:
                ...
                y = None
            loss = loss_fn(net=model, images=imgs, labels=y, augment_pipe=None).mean()
